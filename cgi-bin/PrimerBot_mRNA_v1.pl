...
sub export_primers {
	...
	my $my_hs_URL = '"http://genome.ucsc.edu/cgi-bin/hgPcr?hgsid=317564407&org=Human&db=hg19&wp_target=hg19Kgv14&wp_f='.$row_left[8]."+&wp_r=".$row_right[8].'+&Submit=submit&wp_size=4000&wp_perfect=15&wp_good=15&boolshad.wp_flipReverse=0"';  
	my $my_mm_URL = '"http://genome.ucsc.edu/cgi-bin/hgPcr?hgsid=319719509&org=Mouse&db=mm10&wp_target=mm10Kgv13&wp_f='.$row_left[8]."+&wp_r=".$row_right[8].'+&Submit=submit&wp_size=4000&wp_perfect=15&wp_good=15&boolshad.wp_flipReverse=0"';
	my $mylink;
